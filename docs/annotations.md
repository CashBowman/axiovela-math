...
The preview's **three-dot menu → Export annotations** exports all saved notes, including earlier revisions and notes detached from the composer. Turn off Annotate for a clean reading view. Print/PDF from the Markdown preview excludes review controls and highlights.
