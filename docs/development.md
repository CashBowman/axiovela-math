...
`npm run test:connections` exercises duplicate migration/backup, filters and AI badges, typed graph import, source context, cross-panel feedback routing/dismissal, and automatic PDF refresh. Fixtures do not establish the mathematical quality of model-authored relationships.
