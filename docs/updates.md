...
Download the **0.1.16-beta.3 Windows x64 installer** from its [private release page](https://github.com/CashBowman/axiovela-math/releases/tag/v0.1.16-beta.3), using a GitHub account with repository access. It is built and install/launch/uninstall tested on Windows, but remains unsigned. The 0.1.16-beta.2 Apple silicon DMG remains resource-seal verified and launch-tested on macOS. Linux x64 packages remain validated in 0.1.15-beta.1; Mac Intel remains a development preview awaiting native acceptance.
